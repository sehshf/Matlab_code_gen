...
#include "SimpleGain.h"                /* Model's header file */
...
void * base_rate()
{
  ...
  while (rtmGetErrorStatus(SimpleGain_M) == NULL && !rtmGetStopRequested
         (SimpleGain_M)) {
...
int_T main(int_T argc, const char_T *argv[])
{
  ...
  /* Terminate model */
  SimpleGain_terminate();
  errStatus = rtmGetErrorStatus(SimpleGain_M);
...
/* Local Variables: */
/* compile-command: "make -f SimpleGain.mk" */
/* End: */
