...
MODEL                   = rpi_dc_motor_control
MODULES                 = ert_main.c rpi_dc_motor_control_data.c rpi_gpclk.c rpi_gpio.c rpi_spi.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE                = rpi_dc_motor_control.mk
MATLAB_ROOT             = C:\Matlab2014a\MATLAB\R2014a
ALT_MATLAB_ROOT         = C:\Matlab2014a\MATLAB\R2014a
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\ses\Documents\MATLAB\code_gen\rpi-rt-control-master\simulink
S_FUNCTIONS             = sfPWMwDirOutput.c sfIRCInput.c
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = PCWIN64
BUILDARGS               = OPT_OPTS="-O2 -ggdb -Wall" CC=arm-linux-gnueabihf-gcc GENERATE_ASAP2=0 OPTS="-DRT -DUSE_RTMODEL -DERT"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
MODELLIB                  = rpi_dc_motor_controllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)\rpi_dc_motor_control_ert_linux \
	-I$(START_DIR) \
